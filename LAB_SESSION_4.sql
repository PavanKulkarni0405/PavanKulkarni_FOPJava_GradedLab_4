...
create table customer(cus_id int unsigned primary key auto_increment, cus_name varchar(20) not null, cus_phone varchar(10) not null,cus_city varchar(30) not null,cus_gender enum('M', 'F')not null);
drop table customer;
describe customer;
create table category(cat_id int unsigned primary key auto_increment, cat_name varchar(20) not null);

create table product( pro_id int unsigned primary key auto_increment, pro_name varchar(20) not null, pro_desc varchar(60), cat_id int unsigned, foreign key (cat_id) references category(cat_id)); 
describe product;
